...
import com.example.gestionpisoscompartidos.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(
        ...
        binding.btnCrearPiso.setOnClickListener {
            findNavController().navigate(R.id.action_homeFragment_to_crearPisoFragment)
        }
